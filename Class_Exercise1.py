...
def start_conversion():
    ...
    Base-10 to Binary (5)
    Base-10 to Hexadecimal (6)''') #A comment block was used to inprove formatting
    ...
    if (conversion_type == 1):
        num = int(input("What is the binary number?"), 2) # in int(x, 2) the 2 is used to show that the input is a base 2 (binary) number
